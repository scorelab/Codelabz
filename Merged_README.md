...
- [Firebase Emulator Flow](#firebase-emulator-flow)
  - [Install](#install)
    ...
    - [Install the Emulator Suite](#install-the-emulator-suite)
  - [Configure](#configure)
  ...
  - [Integrate with your CI System](#integrate-with-your-ci-system)
    - [Start the Emulators](#start-the-emulators)
...
3. Run `npm install` in `CodeLabz/functions ` folder.
...
4. Then you have to generate a private key file for your service account.To get the key file go to this link and follow the instructions https://firebase.google.com/docs/admin/setup#initialize-sdk.

5. Once you have obtained the key, create a folder named as **'private'** in the directory **'CodeLabz/functions'**. Then copy and paste the key file in private folder.
6. Rename the key file as **'cl-dev-pk.json'**
7. After that change the database url to your project database url in **'CodeLabz/functions/auth.js'**
8. Move to the root directory and open a command prompt and type following commands
...
9. Find the project ID from the project list that you want to deploy the cloud functions
