/*!
 * FireCode is an open-source, collaborative code and text editor. It was designed
  ...
  function () {
    ...
    firepad.AnnotationList = (function () {
      ...
      AnnotationList.prototype.getAffectedNodes_ = function (span) {
        ...
        if (
          current === null &&
          !(span.length === 0 && span.pos === currentPos)
        ) {
          throw new Error(
        ...
        _createClass(ACEAdapter, [
          ...
          },
          {
            ...
            value: function onChange(change) {
              ...
              if (!this.ignoreChanges) {
                ...
                this.trigger.apply(
                  this,
                  ["change"].concat(_toConsumableArray(pair))
                );
          ...
          },
          {
            ...
            value: function operationFromACEChange(change) {
              ...
              insert_op = new firepad.TextOperation()
                .retain(start)
                .insert(text)
                .retain(restLength);
              delete_op = new firepad.TextOperation()
                .retain(start)
                ["delete"](text)
                .retain(restLength);
          ...
          },
          {
            ...
            value: function setOtherCursor(cursor, color, clientId) {
              ...
              cursorRange.id = this.aceSession.addMarker(
                cursorRange,
                clazz,
                "text"
              );
          ...
          },
          {
            ...
            value: function trigger(event) {
              ...
              return (ref = this.callbacks) != null
                ? (ref1 = ref[event]) != null
    ...
    var MonacoAdapter = (function () {
       ...
       */
      MonacoAdapter.prototype.applyOperation = function applyOperation(
        operation
      ) {
        if (!operation.isNoop()) {
          this.ignoreChanges = true;
  ...
  */
    ...
    firepad.RichTextCodeMirror = (function () {
      ...
      RichTextCodeMirror.prototype.toggleAttribute = function (
        ...
        if (this.emptySelection_()) {
          ...
          var newValue =
            attributes[attribute] !== trueValue ? trueValue : false;
      ...
      RichTextCodeMirror.prototype.onAnnotationsChanged_ = function (
        ...
        for (i = 0; i < newNodes.length; i++) {
          ...
          if (forLine) {
            ...
            var className = this.getClassNameForAttributes_(
              annotation.attributes
            );
            if (className !== "") {
      ...
      RichTextCodeMirror.prototype.markEntity_ = function (annotationNode) {
        ...
        for (var i = 0; i < annotationNode.length; i++) {
          ...
          var element = this.entityManager_.renderToElement(
            entity,
            entityHandle
          );
          if (element) {
      ...
      RichTextCodeMirror.prototype.markLineSentinelCharactersForChangedLines_ = function (
        ...
        if (startLine < Number.MAX_VALUE) {
          while (
            startLine > 0 &&
            this.lineIsListItemOrIndented_(startLine - 1)
          ) {
            startLine--;
          }
        }
      ...
      RichTextCodeMirror.prototype.deleteLeft = function () {
        ...
        var backspaceAtStartOfLine =
          this.emptySelection_() && cursorPos.ch === 1;
      ...
      RichTextCodeMirror.prototype.deleteRight = function () {
        ...
        var nextLineText =
          cursorPos.line + 1 < cm.lineCount()
            ? cm.getLine(cursorPos.line + 1)
            : "";
        if (
    ...
    firepad.RichTextCodeMirrorAdapter = (function () {
      ...
      RichTextCodeMirrorAdapter.prototype.invertOperation = function (
        ...
        for (
          var opIndex = 0;
          opIndex < operation.wrapped.ops.length;
          opIndex++
        ) {
    ...
    firepad.ParseHtml = (function () {
      ...
      ParseOutput.prototype.newline = function (state) {
        ...
        if (this.currentLineListItemType !== null) {
          lineFormatting = lineFormatting.listItem(
            this.currentLineListItemType
          );
          this.currentLineListItemType = null;
        }
          ...
          case Node.ELEMENT_NODE:
            ...
            switch (node.nodeName.toLowerCase()) {
              ...
              case "u":
                parseChildren(
                  node,
                  state.withTextFormatting(
                    state.textFormatting.underline(true)
                  ),
                  output
                );
                break;
              ...
              case "font":
                ...
                if (face) {
                  state = state.withTextFormatting(
                    state.textFormatting.font(face)
                  );
                }
                if (color) {
                  state = state.withTextFormatting(
        ...
        while (op) {
          ...
          for (var attr in attrs) {
            ...
            if (
              ...
              utils.log(
                false,
                "Encountered unknown attribute while rendering html: " + attr
              );
            }
    ...
    // Export FirepadUserList
    firepad.Firepad.FirepadUserList = firepad.FirepadUserList;

    // Export adapters
    firepad.Firepad.RichTextCodeMirrorAdapter =
      firepad.RichTextCodeMirrorAdapter;
