...
const style = {
  ...
  const availableTags = ['HTML', 'javaScript', 'Css', 'Python', 'React', 'Java', 'System Design', 'Cyber Security', 'Node', 'Django', 'C', 'C++', 'GoLang', 'ML', 'AI/ML', 'Cloud', 'DevOps', 'Figma', 'Angular']; // Add your tags here
              ...
              <CardContent>
                ...
                <Grid item xs={16}  className={classes.hashbutton}>
                  {selectedTags.map((tag) => (
                    <Button sx={{mt:1, ml:1}} key={tag} className={classes.hashtag} disableRipple>
                      #{tag}
                    </Button>
                  ))}
                  <Grid item xs={2}>
                    <Fab size="small" color="primary" aria-label="add" onClick={handleOpenModal}>
                      <AddIcon />
                    </Fab>
                  </Grid>
                </Grid>
