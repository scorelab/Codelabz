...
const ForgotPassword = ({
  ...
  const isValidEmail = /[a-z]+.*@gmail\.com/;

  // Disable button if email format is incorrect
  const isButtonDisabled = !isValidEmail.test(email);
    ...
    <Card className={classes.root} data-testId="forgotPassword">
      ...
      <form onSubmit={onSubmit}>
        ...
        <Button
          ...
          disabled={isButtonDisabled} // Disable the button if email format is incorrect
        >
